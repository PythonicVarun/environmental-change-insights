...
async function loadData() {
    ...
    const [summary, overlay, boundary, wardOverlay, waybackConfig] = await Promise.all([
        ...
        loadResource("overlay", "https://proxy.pythonicvarun.me/https://github.com/PythonicVarun/olmoearth-change-insights/releases/download/assets-2026-05-19/kanpur_nagar-overlay.geojson", {
